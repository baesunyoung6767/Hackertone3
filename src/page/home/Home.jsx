    ...
    return (
      <div className='text-center'>
        ...
        <div className="scroll-smooth h-screen snap-y overflow-x-scroll snap-mandatory">
          <Searchpage />
          <Sectionpage title="곧 진행될 축제" add="http://43.200.163.136:8080/api/festival/main?status=START" />
          <Sectionpage title="현재 진행중인 축제" add="http://43.200.163.136:8080/api/festival/main?status=GOING" />
